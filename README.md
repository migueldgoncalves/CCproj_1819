...
Pasar a la pantalla siguiente, [Discos](https://github.com/migueldgoncalves/CCproj_1819/blob/master/docs/Provisionamiento/04.png). El disco del sistema operativo puede ser HDD estándar para ahorrar diñero, no es necesário más para correr la aplicación. Crear y adjuntar un nuevo disco de datos de 1 GB, vacío y de tipo también HDD estándar, con un nombre cualquier. Mantener seleccionada la opción por defecto de Sí en "Usar discos administrados".
